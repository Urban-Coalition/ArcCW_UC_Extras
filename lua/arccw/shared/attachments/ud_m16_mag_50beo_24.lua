...
att.Description = "Quad-Stack 5.56mm magazines converted to load .50 Beowulf rounds in a Double-Stack stack. Loading something like this is well outside of plausability."
att.Desc_Pros = {}
att.Desc_Cons = {}
att.Desc_Neutrals = {}
att.Slot = "ud_m16_mag"
