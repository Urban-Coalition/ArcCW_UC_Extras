...
att.Description = "Modern stamped receiver derived from the AK-12/400 rifle. Shares the same glossy finish and rails; otherwise, it functions similarly to regular stamped AKMs."
att.Desc_Neutrals = {
    "uc.cosmetic"
}
att.Slot = {"ur_ak_cal"}
